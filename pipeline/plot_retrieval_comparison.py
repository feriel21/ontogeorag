...
ax1.set_xticks(x)
ax1.set_xticklabels(configs, fontsize=11, fontweight="bold", color="#000000")
ax1.set_ylim(0, 90)
...
legend = ax1.legend(
    fontsize=10, framealpha=1.0, edgecolor="#000000", loc="upper left"
)
...
ax2.set_ylabel(
    "Silent query rate (%)", fontsize=12, fontweight="bold", color="#000000"
)
ax2.set_title(
    "Fraction of queries producing\nno extracted triples",
    fontsize=12,
    fontweight="bold",
    color="#000000",
    pad=10,
...
ax2.set_xticks(x)
ax2.set_xticklabels(configs, fontsize=11, fontweight="bold", color="#000000")
ax2.set_ylim(0, 100)
...
patches = [
    mpatches.Patch(
        ...
        edgecolor="#000000",
        linewidth=1.2,
        label="Memory only (no retrieval)",
    ),
    mpatches.Patch(
        facecolor="#90CAF9",
        edgecolor="#000000",
    ...
    mpatches.Patch(
        ...
        edgecolor="#000000",
        linewidth=1.2,
        label="C10 — BM25 + cross-encoder re-ranking",
    ),
]
fig.legend(
    handles=patches,
...
plt.savefig(
    "figures/fig_retrieval_comparison.png",
    dpi=300,
    bbox_inches="tight",
    facecolor=BG,
)
